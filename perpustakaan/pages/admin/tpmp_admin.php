...
<head>
    ...
    <title>Perpustakaan SMK NEGERI 1 PADAHERANG | Teknik Pengolahan Migas dan Petrokimia (TPMP)</title>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Data Buku Jurusan Teknik Pengolahan Migas dan Petrokimia (TPMP)
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM buku where jurusan='Teknik Pengolahan Migas dan Petrokimia (TPMP)'";
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <td class="text-center">
                                                    ...
                                                    <a href="../../controller/buku_deleteController.php?id=<?= $buku['id_buku']; ?>" class="btn btn-sm btn-danger" >  Hapus Buku </a>
                                                </td>
                                            <?php
                                                echo "</tr>";
                                            } ?>
