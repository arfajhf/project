...
<head>
    ...
    <title>Perpustakaan SMK NEGERI 1 PADAHERANG | Teknik Elektronika Industri (TEIN)</title>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Data Buku Jurusan Teknik Elektronika Industri (TEIN)
                            </div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM buku where jurusan='Teknik Elektronika Industri (TEIN)'";
