                ...
                <div class="col-md-9 col-md-offset-2">
                    <div class="login-panel panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title text-center">Inputkan Buku <br> Novel</h3>
                        </div>
                        <div class="panel-body">
                            <form  action="../../controller/novelController.php" method="post">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Judul Buku" name="judul" type="text" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Pengarang Buku" name="pengarang" type="text" autofocus>
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Penerbit Buku" name="penerbit" type="text" value="">
                                    </div>
                                    <div class="form-group">
